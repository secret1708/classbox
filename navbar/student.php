<div class="nav-container">
    <div class="navbar">
      <h1 class="currentpage"><?= $title ?></h1>
        <div class="full-navbar">
          <a href="class_list.php"><button class="navbutton">Class list</button></a>
          <a href="assig_student.php"><button class="navbutton" >Assignment</button></a>
    ...
    <div class="small-navbar invis-nav">
        <a href="class_list.php"><button class="navbutton-sm">Class list</button></a>
        <a href="assig_student.php"><button class="navbutton-sm" >Assignment</button></a>
